...
var mull= a*b;
 ...
 var message2 = `The product of ${a} and ${b} is ${mull}.`;
 return [mull, message2];
...
function sumArray(sumArr) { //eslint-disable-line
 ...
 var massage4=`${testArray[0]},${testArray[1]},${testArray[2]} was passed in as an array of numbers, and ${num} is their sum.`;
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  num2=multiply(num2, testArray[i])[0];
 }
 var massage5=`The numbers ${testArray[0]},${testArray[1]},${testArray[2]} have a product of ${num2}.`;

 return[num2, massage5];
